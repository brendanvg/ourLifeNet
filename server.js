...
var bundle = browserify_express({
	...
	write_file: __dirname + '/public/js/bundle.js',
	ignore: ['optional.js']
})
*/
...
var corsOption = {
  origin: 'http://www.ourlifenet.com:3000'
}
var collect = require('collect-stream')

app.use(express.static('public'))
//app.use(browserify('./js/'))
//app.get('/js/bundle.js', browserify('./js/entry.js'))
...
/*var bundle = browserify_express({
        ...
        minify: true,
        bundle_opts: {debug: true},
        write_file: __dirname + '/public/bundle.js',
        ignore: ['optional.js']
})
*/
console.log('hap', __dirname + '/js/entry.js', 'or', __dirname + '/js')
...
app.get('/public/bundle.js', function(req,res) {
	console.log('trying to send bundle')
...
app.post('/signUp3', function(req,res){
	...
	res.render('signUp', {
		message: 'Username already being used, please choose another.'
	})
      }
    })
...
app.get('/enterChat', function(req,res,next){
  res.sendFile('http://ourlifenet.com:5003/public/chat.html')
})
